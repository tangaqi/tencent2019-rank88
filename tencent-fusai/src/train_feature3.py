...
name = ['track_log_20190410', 'track_log_20190411', 'track_log_20190412', 'track_log_20190413', 'track_log_20190414',
        ...
        'track_log_20190422']
# name = ['track_log_20190410']
'''
统计竞争队列里面的rate特征，用的是平移两天的rate，test集合对应的是22号的rate
...
for na in name:
    ...
    fea_day.to_csv('../usingData/feature/com/' + str(day2) + '_compete_rate.csv', index=False)