# -*- coding: utf-8 -*-
"""
@file:make_old_ad_cross_rate.py
@time:2019/6/11 19:24
@author:Tangj
@software:Pycharm
@Desc
"""
...
train_use2.to_csv('../usingData/feature/new_ad_cross_rate_train.csv', index=False)
test_use2.to_csv('../usingData/feature/new_ad_cross_rate_test4.csv', index=False)